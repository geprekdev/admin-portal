...
@section('title')
  <title>Rekap Kehadiran Sekolah Siswa | Siamawolu Admin</title>
@endsection
...
@section('header')
  <h1 class="m-0">Rekap Kehadiran Sekolah Siswa</h1>
@endsection
  ...
  <div class="col-12">
    <div class="card">
      {{-- <div class="card-tools d-flex flex-column flex-md-row justify-content-end mt-3 mx-4">
        <form class="d-flex flex-column flex-md-row" action="{{ route('recaps.student-attendance') }}" method="get">
      ...
      <div class="card-body">
        <table id="student-attendances-table" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th>#</th>
              <th>Nama</th>
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#student-attendances-table")
        ...
        .buttons()
        .container()
        .appendTo("#student-attendances-table_wrapper .col-md-6:eq(0)");
    });
  </script>
@endsection
